...
export const Careers = () => {
  ...
  useEffect(() => {
    ...
    if (params.get('submitted') === 'true') {
      setIsSubmitted(true)
      // Clean up the URL silently so reloading doesn't show the success state again
      navigate(location.pathname, { replace: true })
      // Scroll down to the success message
      setTimeout(() => {
  ...
  const handleApplyClick = (positionValue: string) => {
    ...
    // Smoothly glide down to the form, offsetting for the fixed header
          ...
          <AnimatedSection delay={0.2}>
            {isSubmitted ? (
              ...
              >
                ...
                {/* Redirect back to this exact page with a success trigger parameter */}
